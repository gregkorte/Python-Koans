...
class AboutRegex(Koan):
    ...
    def test_matching_literal_text_how_many(self):
        ...
        m = re.findall('Felix', string).count('Felix') #TIP: Maybe match it's not the best option
    ...
    def test_matching_any_character(self):
        ...
        change_this_search_string = '[e]' # <-- I want to find all uses of myArray
    ...
    def test_anything_but_matching(self):
        ...
        change_this_search_string = '[^b-ln-rt-z1-9]am.xls'
